...
export default function SignUp() {
    ...
    return (
            ...
            <div className="max-w-md mx-auto p-6 bg-green-50 shadow-lg rounded-md border border-green-300 mt-6">
                <h1 className="text-2xl font-bold mb-6 text-green-700">Registro de Usuario</h1>
                ...
                <input
                    ...
                    className="w-full p-3 mb-4 border border-green-300 rounded-md focus:outline-none focus:ring focus:ring-green-200"
                />
